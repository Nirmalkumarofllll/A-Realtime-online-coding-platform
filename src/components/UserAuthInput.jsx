...
const UserAuthInput = ({
  ...
  return <div className='flex flex-col items-start justify-start'>
        ...
        >
            ...
            <input type={isPass && showPass ? "password" : "text"} placeholder={placeHolder} className='flex-1 w-full h-full py-2 outline-none border-none bg-transparent text-gray-600 text-lg'
            value={value}
